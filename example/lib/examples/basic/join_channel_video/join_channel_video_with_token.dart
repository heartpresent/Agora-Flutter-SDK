...
class _State extends State<JoinChannelVideo> {
  ...
  int tokenExpireTime = 5; // Expire time in Seconds.
  ...
  Future<void> fetchToken() async {
    // Prepare the Url
    String url = '${config.serverUrl}/rtc/${_controller.text}/${tokenRole.toString()}/uid/0?expiry=${tokenExpireTime.toString()}';
    ...
    if (response.statusCode == 200) {
      ...
      logSink.log('Token Received: $newToken');
  ...
  void setToken(String newToken) async {
    ...
    if (isTokenExpiring) {
      ...
      logSink.log("Token renewed");
    } else {
      // Join a channel.
      logSink.log("Token received, joining a channel...");
