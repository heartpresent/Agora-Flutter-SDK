import 'package:agora_rtc_engine/src/web/event_types.dart';
...
class RtcEngineEventHandler {
  ...
  ///
  final ApiCallCallback? apiCallExecuted;
  ...
  ///
  // UidWithElapsedAndChannelCallback? onJoinChannelSuccess;
  ...
  ///  callback.
  ///
  final UidWithElapsedAndChannelCallback? rejoinChannelSuccess;
  ...
  ///
  final UserAccountCallback? localUserRegistered;
  ...
  ///
  final UserInfoCallback? userInfoUpdated;
  ...
  ///
  ///
  final ClientRoleCallback? clientRoleChanged;
  ...
  ///
  ///
  final ConnectionStateCallback? connectionStateChanged;
  ...
  ///
  ///
  final NetworkTypeCallback? networkTypeChanged;
  ...
  ///
  final EmptyCallback? connectionLost;
  ...
  ///
  final TokenCallback? tokenPrivilegeWillExpire;
  ...
  ///
  final EmptyCallback? requestToken;
  ...
  ///
  final AudioVolumeCallback? audioVolumeIndication;
  ...
  ///
  final UidCallback? activeSpeaker;
  ...
  ///
  @Deprecated('')
  final ElapsedCallback? firstLocalAudioFrame;
  ...
  ///
  final VideoFrameCallback? firstLocalVideoFrame;
  ...
  ///
  @Deprecated('')
  final UidWithMutedCallback? userMuteVideo;
  ...
  ///
  final VideoSizeCallback? videoSizeChanged;
  ...
  ///  callback.
  ///
  final RemoteVideoStateCallback? remoteVideoStateChanged;
  ...
  ///
  ///
  final LocalVideoStateCallback? localVideoStateChanged;
  ...
  ///
  final RemoteAudioStateCallback? remoteAudioStateChanged;
  ...
  ///
  final LocalAudioStateCallback? localAudioStateChanged;

  /// @nodoc
  @Deprecated('Use requestAudioFileInfo instead')
  final RequestAudioFileInfoCallback? requestAudioFileInfoCallback;
  ...
  ///
  final RequestAudioFileInfoCallback? requestAudioFileInfo;
  ...
  ///
  ///
  final FallbackCallback? localPublishFallbackToAudioOnly;
  ...
  ///
  ///
  final FallbackWithUidCallback? remoteSubscribeFallbackToAudioOnly;
  ...
  ///
  ///
  final AudioRouteCallback? audioRouteChanged;
  ...
  ///
  final RectCallback? cameraFocusAreaChanged;
  ...
  /// Param [rect] The focus rectangle in the local preview.
  ///
  final RectCallback? cameraExposureAreaChanged;
  ...
  ///
  final FacePositionCallback? facePositionChanged;
  ...
  ///
  ///
  final RtcStatsCallback? rtcStats;
  ...
  ///
  ///
  final NetworkQualityCallback? lastmileQuality;
  ...
  ///
  ///
  final NetworkQualityWithUidCallback? networkQuality;
  ...
  ///
  final LastmileProbeCallback? lastmileProbeResult;
  ...
  ///
  final LocalVideoStatsCallback? localVideoStats;
  ...
  ///
  final LocalAudioStatsCallback? localAudioStats;
  ...
  ///
  final RemoteVideoStatsCallback? remoteVideoStats;
  ...
  ///
  final RemoteAudioStatsCallback? remoteAudioStats;
  ...
  final EmptyCallback? audioMixingFinished;
  ...
  ///
  final AudioMixingStateCallback? audioMixingStateChanged;
  ...
  ///
  final SoundIdCallback? audioEffectFinished;
  ...
  ///
  final RtmpStreamingStateCallback? rtmpStreamingStateChanged;
  ...
  ///
  final EmptyCallback? transcodingUpdated;
  ...
  ///
  final StreamInjectedStatusCallback? streamInjectedStatus;
  ...
  ///
  final StreamMessageCallback? streamMessage;
  ...
  ///
  final StreamMessageErrorCallback? streamMessageError;

  ///
  /// Occurs when the media engine loads.
  ///
  ///
  final EmptyCallback? mediaEngineLoadSuccess;

  ///
  /// Occurs when the media engine call starts.
  ///
  ///
  final EmptyCallback? mediaEngineStartCallSuccess;
  ...
  ///
  ///
  final MediaRelayStateCallback? channelMediaRelayStateChanged;
  ...
  ///
  ///
  final MediaRelayEventCallback? channelMediaRelayEvent;
  ...
  ///
  @Deprecated('')
  final VideoFrameWithUidCallback? firstRemoteVideoFrame;
  ...
  final UidWithElapsedCallback? firstRemoteAudioFrame;
  ...
  ///
  @Deprecated('Please use remoteAudioStateChanged instead.')
  final UidWithElapsedCallback? firstRemoteAudioDecoded;
  ...
  ///
  @Deprecated('')
  final UidWithMutedCallback? userMuteAudio;
  ...
  final UrlWithErrorCallback? streamPublished;
  ...
  ///
  @Deprecated('Please use rtmpStreamingStateChanged instead.')
  final UrlCallback? streamUnpublished;
  ...
  final TransportStatsCallback? remoteAudioTransportStats;
  ...
  final TransportStatsCallback? remoteVideoTransportStats;
  ...
  ///
  @Deprecated('')
  final UidWithEnabledCallback? userEnableVideo;
  ...
  ///
  @Deprecated('')
  final UidWithEnabledCallback? userEnableLocalVideo;
  ...
  ///
  @Deprecated('')
  final VideoFrameWithUidCallback? firstRemoteVideoDecoded;
  ...
  ///
  @Deprecated('')
  final EnabledCallback? microphoneEnabled;
  ...
  final EmptyCallback? connectionInterrupted;
  ...
  ///
  @Deprecated('Please use connectionStateChanged instead.')
  final EmptyCallback? connectionBanned;
  ...
  ///
  @Deprecated('')
  final AudioQualityCallback? audioQuality;
  ...
  ///
  @Deprecated('')
  final EmptyCallback? cameraReady;
  ...
  ///
  @Deprecated('')
  final EmptyCallback? videoStopped;
  ...
  ///
  final MetadataCallback? metadataReceived;
  ...
  ///
  final ElapsedCallback? firstLocalAudioFramePublished;
  ...
  /// Param [elapsed] The time elapsed(ms) from the local client calling joinChannel until the SDK triggers this callback.
  ///
  final ElapsedCallback? firstLocalVideoFramePublished;
  ...
  ///
  final StreamPublishStateCallback? audioPublishStateChanged;
  ...
  /// Param [elapseSinceLastState] The time elapsed (ms) from the previous state to the current state.
  ///
  final StreamPublishStateCallback? videoPublishStateChanged;
  ...
  /// Param [elapseSinceLastState] The time elapsed (ms) from the previous state to the current state.
  ///
  final StreamSubscribeStateCallback? audioSubscribeStateChanged;
  ...
  /// Param [elapseSinceLastState] The time elapsed (ms) from the previous state to the current state.
  ///
  final StreamSubscribeStateCallback? videoSubscribeStateChanged;
  ...
  ///
  final RtmpStreamingEventCallback? rtmpStreamingEvent;
  ...
  ///
  final UserSuperResolutionEnabledCallback? userSuperResolutionEnabled;
  ...
  ///
  final UploadLogResultCallback? uploadLogResult;

  /// @nodoc
  @Deprecated('Use airPlayConnected instead')
  final EmptyCallback? airPlayIsConnected;

  ///
  /// Occurs when the audio route switches to Apple AirPlay (iOS and macOS only)。
  ///
  ///
  final EmptyCallback? airPlayConnected;
  ...
  ///
  final VirtualBackgroundSourceEnabledCallback? virtualBackgroundSourceEnabled;
  ...
  ///
  final VideoDeviceStateChanged? videoDeviceStateChanged;
  ...
  ///
  final AudioDeviceVolumeChanged? audioDeviceVolumeChanged;
  ...
  ///
  final SnapshotTakenCallback? snapshotTaken;
  ...
  ///
  ///
  final OnScreenCaptureInfoUpdated? screenCaptureInfoUpdated;

  /// @nodoc
  final OnClientRoleChangeFailed? clientRoleChangeFailed;

  /// @nodoc
  final OnWlAccMessage? wlAccMessage;

  /// @nodoc
  final OnWlAccStats? wlAccStats;
  ...
  ///
  final OnProxyConnected? proxyConnected;
  ...
  ///
  ///
  final OnAudioDeviceTestVolumeIndication? audioDeviceTestVolumeIndication;

  /// @nodoc
  final OnContentInspectResult? contentInspectResult;
  ...
  ///
  final OnLocalVoicePitchInHz? localVoicePitchInHz;
