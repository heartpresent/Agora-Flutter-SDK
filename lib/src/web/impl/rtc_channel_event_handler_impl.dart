...
import 'package:agora_rtc_engine/src/web/impl/event_handler_json.dart';
import 'package:agora_rtc_engine/src/web/rtc_channel_event_handler.dart';
...
extension RtcChannelEventHandlerExt on RtcChannelEventHandler {
  void process(String channelId, String methodName, dynamic data,
    ...
    switch (methodName) {
      case 'ChannelWarning':
        onWarning?.call(WarningCodeConverter.fromValue(newData[0]).e);
        break;
      case 'ChannelError':
        onError?.call(ErrorCodeConverter.fromValue(newData[0]).e);
        break;
