...
@JsonSerializable()
class AudioProfileConverter extends EnumConverter<AudioProfileType, int> {
...
@JsonSerializable()
class AudioScenarioConverter extends EnumConverter<AudioScenarioType, int> {
...
@JsonSerializable()
class ClientRoleConverter extends EnumConverter<ClientRoleType, int> {
