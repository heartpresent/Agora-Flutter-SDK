...
import 'package:agora_rtc_engine/src/web/rtc_channel.dart';
import 'package:agora_rtc_engine/src/web/rtc_device_manager.dart';
...
class RtcEngineImpl with MediaRecorderImplMixin implements RtcEngine {
  ...
  Future<void> joinChannelWithUserAccount(
      {String? token, required String channelId, required String userAccount,
        ChannelMediaOptions? options}) {
    return _invokeMethod('callApi', {
  ...
  @override
  Future<void> playEffect({required int soundId,
